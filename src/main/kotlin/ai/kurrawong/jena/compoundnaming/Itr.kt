...
class Itr3<X>(
    ...
    override fun hasNext(): Boolean = idx < 3
...
class Itr4<X>(
    ...
    override fun hasNext(): Boolean = idx < 4
...
class Itr5<X>(
    ...
    override fun hasNext(): Boolean = idx < 5
 ...
 */
object Itr {
    fun <X> iter0(): Iterator<X> = Itr0()

    fun <X> iter1(x1: X): Iterator<X> = Itr1(x1)

    fun <X> iter2(
        x1: X,
        x2: X,
    ): Iterator<X> = Itr2(x1, x2)

    fun <X> iter3(
        x1: X,
        x2: X,
        x3: X,
    ): Iterator<X> = Itr3(x1, x2, x3)
    ...
    fun <X> iter5(
        ...
        x4: X,
        x5: X,
    ): Iterator<X> = Itr5(x1, x2, x3, x4, x5)
}
